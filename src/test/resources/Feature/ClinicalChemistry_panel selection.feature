...
Feature: Clinical Chemistry casetype End to End flow
  ...
  @clinicalChemistry @accession @case
  ...
  Scenario: File generation and finalization
    ...
    And the user processing the report generation process
    And click mark for physician toggle for clinical chemistry
